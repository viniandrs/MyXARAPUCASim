...
{   
    ...
    G4ThreeVector pos5 = G4ThreeVector(0, -0.75*cm, 0.5*(-0.5*H_b + 0.5*bigger_base_height + dif_h - esp + (b_maior - a_maior)));
    G4ThreeVector pos6 = G4ThreeVector(0, 3.0*cm - 0.5*esp_alpha, 0.5*(-0.5*H_b + 0.5*bigger_base_height + dif_h - esp));
    ...
    G4ThreeVector pos11 = G4ThreeVector(0, -0.75*cm + 0.25*espeAra, 0.5*(-0.5*H_b + 0.5*bigger_base_height + dif_h - esp + (b_maior - a_maior) ));
    G4ThreeVector pos12 = G4ThreeVector(0, -0.75*cm - 0.25*espeAra, 0.5*(-0.5*H_b + 0.5*bigger_base_height + dif_h - esp + (b_maior - a_maior)));
    ...
    G4ThreeVector trans7 = G4ThreeVector(0, -0.75*cm, -0.5*(h_b + smaller_height)+0.5*esp + a_menor + 0.5*(b_maior - a_maior));
    G4ThreeVector trans8 = G4ThreeVector(0, 3.0*cm - 0.5*esp_alpha, -0.5*(h_b + smaller_height)+0.5*esp + a_menor);
    ...
    G4ThreeVector trans11 = G4ThreeVector(0, -0.75*cm + 0.25*espeAra, -0.5*(h_b + smaller_height)+0.5*esp + a_menor + 0.5*(b_maior - a_maior));
    G4ThreeVector trans12 = G4ThreeVector(0, -0.75*cm - 0.25*espeAra, -0.5*(h_b + smaller_height)+0.5*esp + a_menor + 0.5*(b_maior - a_maior));
